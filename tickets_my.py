...
Examples：
    ...
    ttickets_my.py -dg 成都 南京 2017-07-01
"""
...
trainOption = input(f"{'-d动车 -g高铁 -k快速 -t特快 -z直达,Please input the trainType you want to search :'}")
fromStation = input(f"{'Please input the city you want leave :'}")
toStation = input(f"{'Please input the city you will arrive :'}")
